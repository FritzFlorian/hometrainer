"""Handles everything related to neural network.

The main class of interest is the NeuralNetwork class.
Overwrite it with your custom neural network functionality."""
import pickle
...
class NeuralNetwork:
    ...
    def construct_network(self, sess, graph):
        """Construct your network by building up the tensorflow graph structure in this method.
        Will be called once when setting up the network."""
        raise NotImplementedError("Add the construction of your custom graph structure.")

    def init_network(self):
        """Run code like variable initialization and so on in this method.
        Will be called once before training/execution."""
        raise NotImplementedError("Run initialisation code for your network.")

    def input_conversion_function(self):
        """Return a reference to a function doing the input conversion."""
    ...
    def output_conversion_function(self):
        """Return a reference to a function doing the output conversion."""
    ...
    def execute_batch(self, sess, input_arrays):
        """This method is called with the input_arrays generated by your input  conversion function.
        :returns the arrays that will be fed to the output conversion function."""
    ...
    def train_batch(self, sess, input_arrays, output_arrays):
        """Fed with both input arrays and target output arrays. Use these to perform one batch of training."""
        raise NotImplementedError("Add implementation that executes one batch training step.")

    def save_weights(self, sess, filename):
        """Save the weights of the network to the given checkpoint filename.
        This usually simply is calling yor saver with this filename."""
    ...
    def load_weights(self, sess, filename):
        """Load the weights of the network from the given checkpoint filename.
        his usually simply is calling yor saver with this filename."""
    ...
    def log_training_progress(self, sess, tf_file_writer, input_arrays, target_arrays, training_batch):
        """Write logs about the loss and other NN stats to the given file writer."""
